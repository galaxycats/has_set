...
Gem::Specification.new do |s|
  ...
  s.files = ["History.txt", "Manifest.txt", "README.txt", "Rakefile", "has_set.gemspec", "lib/has_set.rb", "pkwde-has_set.gemspec", "script/console", "script/destroy", "script/generate", "test/has_set_test.rb", "test/test_helper.rb"]
  s.has_rdoc = true
